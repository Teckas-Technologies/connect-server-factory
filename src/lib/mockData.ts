...
export const communityServers: ThirdPartyServerProps[] = [
  ...
  },
  {
    ...
    logo: "https://raw.githubusercontent.com/pyroprompts/any-chat-completions-mcp/main/assets/favicon.ico"
  },
  {
    name: "ArangoDB",
  ...
  },
  {
    ...
    logo: "https://cloud.google.com/bigquery/favicon.ico"
  },
  {
  ...
  },
  {
    ...
    logo: "https://github.com/AI-QL/chat-mcp/raw/main/public/icon.png"
  },
  {
    name: "ChatSum",
  ...
  },
  {
    ...
    logo: "https://marketplace.dappier.com/favicon.ico"
  }
  // Note: There's a limit to how many servers we can add at once due to file size.
  // The remaining servers will need to be added in subsequent updates.
];
